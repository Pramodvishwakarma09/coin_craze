...
import 'account_creeated_successfully.dart';

class SignUpEmailOtpPage extends StatelessWidget {
  const SignUpEmailOtpPage({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: PrimaryBtn(btnText: 'Next', btnFun: () {
              Get.to(()=>AccountCreatedSuccessfullyPage());
            },)),
            SizedBox(height: 8.h,),
